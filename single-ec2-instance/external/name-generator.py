...
# Host name generator based on amazing script from https://raw.githubusercontent.com/shamrin/namesgenerator/master/namesgenerator.py by Alexey Shamrin
# just added output in json format
# by Rafal Masiarek <rafal@masiarek.pl>
